...
void load_param(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2);
void save_param(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2);
void init_rand(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2);
...
void load_param(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2)
{
    std::ifstream input("/home/dancoeks/Kuliah/DSEC/NN/params/wnb3L.txt");
    char line_input[50];
    int counter = 0;
    int param = 0;
    ...
    for (std::string line; getline(input, line);)
    {
        ...
        if (param == 2 && counter == first_layer_neuron * output_layer_neuron)
        {
            param++;
            counter = 0;
        }

        if (param == 3 && counter == output_layer_neuron)
        {
            param++;
            counter = 0;
        }
...
void save_param(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2)
{
    std::ofstream outfile("/home/dancoeks/Kuliah/DSEC/NN/params/wnb3L.txt");
    ...
    for (int i = 0; i < first_layer_neuron * output_layer_neuron; i++)
    {
