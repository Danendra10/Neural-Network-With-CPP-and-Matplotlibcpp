...
matrix_t *w3_T;
matrix_t *w2_T;
matrix_t *input_img_T;

matrix_t *
create_matrix(int row, int collumn);
...
void load_param(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2, matrix_t *w3, matrix_t *b3, matrix_t *w4, matrix_t *b4);
void save_param(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2, matrix_t *w3, matrix_t *b3, matrix_t *w4, matrix_t *b4);
void init_rand(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2, matrix_t *w3, matrix_t *b3, matrix_t *w4, matrix_t *b4);
...
void load_param(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2, matrix_t *w3, matrix_t *b3, matrix_t *w4, matrix_t *b4)
{
    std::ifstream input("/home/dancoeks/Kuliah/DSEC/NN/params/wnb5L.txt");
    char line_input[50];
    int counter = 0;
    int param = 0;
    ...
    for (std::string line; getline(input, line);)
    {
        ...
        if (param == 6)
            w4->data[counter / third_layer_neuron][counter % third_layer_neuron] = atof(line_input);
        if (param == 7)
            b4->data[counter][0] = atof(line_input);
        ...
        if (param == 4 && counter == second_layer_neuron * third_layer_neuron)
        {
            param++;
            counter = 0;
        }

        if (param == 5 && counter == third_layer_neuron)
        {
            param++;
            counter = 0;
        }

        if (param == 6 && counter == third_layer_neuron * output_layer_neuron)
        {
            param++;
            counter = 0;
        }

        if (param == 7 && counter == output_layer_neuron)
        {
            param++;
            counter = 0;
        }
...
void save_param(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2, matrix_t *w3, matrix_t *b3, matrix_t *w4, matrix_t *b4)
{
    std::ofstream outfile("/home/dancoeks/Kuliah/DSEC/NN/params/wnb5L.txt");
    ...
    for (int i = 0; i < second_layer_neuron * third_layer_neuron; i++)
    {
        outfile << w3->data[i / second_layer_neuron][i % second_layer_neuron] << "\t\tW3" << std::endl;
    }
    for (int i = 0; i < third_layer_neuron; i++)
    {
        outfile << b3->data[i][0] << "\t\tB3" << std::endl;
    }

    for (int i = 0; i < third_layer_neuron * output_layer_neuron; i++)
    {
        outfile << w4->data[i / third_layer_neuron][i % third_layer_neuron] << "\t\tW4" << std::endl;
    }
    for (int i = 0; i < output_layer_neuron; i++)
    {
        outfile << b4->data[i][0] << "\t\tB4" << std::endl;
    }
...
void init_rand(matrix_t *w1, matrix_t *b1, matrix_t *w2, matrix_t *b2, matrix_t *w3, matrix_t *b3, matrix_t *w4, matrix_t *b4)
{
    std::ofstream outfile("/home/surya/C/DSEC/nn/params/wnb5L.txt");
    ...
    for (int i = 0; i < third_layer_neuron * output_layer_neuron; i++)
    {
        w4->data[i / third_layer_neuron][i % third_layer_neuron] = 2 * ((double)rand() / (double)RAND_MAX) - 1;
        outfile << w4->data[i / third_layer_neuron][i % third_layer_neuron] << "\t\tW4" << std::endl;
    }
    for (int i = 0; i < output_layer_neuron; i++)
    {
